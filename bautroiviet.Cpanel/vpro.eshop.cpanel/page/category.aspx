            ...
            <tr style="height: 20px;">
                ...
                <td height="25">
                    <asp:RadioButtonList ID="rblPos" runat="server" RepeatColumns="5">
                        ...
                        <asp:ListItem Text="Dưới" Value="2"></asp:ListItem>
            ...
            <div>
                <table width="auto" border="0">
                    ...
                    <tr id="trUploadImage2" runat="server">
                        ...
                        <td>
                            <input id="fileImage2" type="file" name="fileImage1" size="50" runat="server" style="width: 500px;">
                        </td>
                    </tr>
                    <tr id="trImage2" runat="server">
                        <th valign="top" class="left">
                            <asp:ImageButton ID="btnDelete2" runat="server" ImageUrl="../images/delete_icon.gif"
                                BorderWidth="0" Width="13px" OnClick="btnDelete2_Click" ToolTip="Xóa hình minh họa này">
                            </asp:ImageButton>
                        </th>
                        <td>
