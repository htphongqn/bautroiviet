    ...
    public partial class news : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                ucDelineDate.returnDate = DateTime.Now.AddMonths(1);
                Loadcity();
                getInfo();
                LoadCategoryParent();
        ...
        private void getInfo()
        {
            try
            {
                ...
                if (G_info.ToList().Count > 0)
                {
                    ...
                    ucDelineDate.returnDate = Utils.CDateDef(G_info.ToList()[0].n.NEWS_SENDDATE, DateTime.Now);
                    ...
                    txtBaohanh.Value = Utils.CStrDef(G_info.ToList()[0].n.NEWS_FIELD1);
                    txtWebsite.Value = Utils.CStrDef(G_info.ToList()[0].n.NEWS_FIELD2);
                    ddlCity.SelectedValue = Utils.CStrDef(G_info.ToList()[0].n.NEWS_FIELD3);
                    txtSoluongban.Value = Utils.CStrDef(G_info.ToList()[0].n.NEWS_FIELD4);
            ...
            try
            {
                ...
                if (_iType == 0 || _iType == 2)
                {
                    if (m_news_id == 0)
                    {
                        ...
                        news_insert.NEWS_FIELD1 = Utils.CStrDef(txtBaohanh.Value);
                        news_insert.NEWS_FIELD2 = Utils.CStrDef(txtWebsite.Value);
                        news_insert.NEWS_FIELD3 = Utils.CStrDef(ddlCity.SelectedValue);
                        news_insert.NEWS_FIELD4 = Utils.CStrDef(txtSoluongban.Value);
                        news_insert.NEWS_SENDDATE = ucDelineDate.returnDate;
                    ...
                    else
                    {
                        ...
                        if (c_update.ToList().Count > 0)
                        {
                            ...
                            c_update.ToList()[0].NEWS_FIELD1 = Utils.CStrDef(txtBaohanh.Value);
                            c_update.ToList()[0].NEWS_FIELD2 = Utils.CStrDef(txtWebsite.Value);
                            c_update.ToList()[0].NEWS_FIELD3 = Utils.CStrDef(ddlCity.SelectedValue);
                            c_update.ToList()[0].NEWS_FIELD4 = Utils.CStrDef(txtSoluongban.Value);
                            c_update.ToList()[0].NEWS_SENDDATE = ucDelineDate.returnDate;
