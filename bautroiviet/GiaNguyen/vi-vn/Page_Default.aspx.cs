    ...
    public partial class Page_Default : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                UserControl list_pro = Page.LoadControl("../UIs/Products.ascx") as UserControl;
                UserControl prodetails = Page.LoadControl("../UIs/Product.ascx") as UserControl;
        ...
        public void Bind_meta_tags_news()
        {
            ...
            propety.Content = "shopluatinh.com" + PathFiles.GetPathNews(Utils.CIntDef(Session["News_id"])) + Utils.CStrDef(Session["News_image3"]);
