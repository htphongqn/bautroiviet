    ...
    public class Search_result
    {
        ...
        public List<Pro_details_entity> Load_search_result(string _txt,int type)
        {
            ...
            var list = (from c in db.ESHOP_NEWS_CATs
                          ...
                          && a.NEWS_TYPE == type
                        select new { a.NEWS_ID, a.NEWS_TITLE, a.NEWS_IMAGE3, a.NEWS_PRICE1, a.NEWS_PRICE2, a.NEWS_PRICE3, a.NEWS_DESC, a.NEWS_SEO_URL, a.NEWS_URL, a.NEWS_ORDER, a.NEWS_ORDER_PERIOD, a.NEWS_PUBLISHDATE, b.CAT_SEO_URL }).Distinct().OrderByDescending(n => n.NEWS_ID).OrderByDescending(n => n.NEWS_ORDER);
