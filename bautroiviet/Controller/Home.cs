        ...
        public List<Pro_details_entity> Loadindex(int type, int period, int limit)
        {
            try
            {
                ...
                var list = (from a in db.ESHOP_NEWS_CATs
                            ...
                            select new { b.NEWS_ID, b.NEWS_TITLE, b.NEWS_IMAGE3, b.NEWS_PRICE1, b.NEWS_PRICE2, b.NEWS_PRICE3, b.NEWS_DESC, b.NEWS_SEO_URL, b.NEWS_URL, b.NEWS_ORDER_PERIOD, b.NEWS_PUBLISHDATE, c.CAT_SEO_URL }).OrderByDescending(n => n.NEWS_PUBLISHDATE).OrderByDescending(n => n.NEWS_ORDER_PERIOD).Take(limit).ToList();
                foreach (var i in list)
                {
                    ...
                    pro.NEWS_PRICE3 = Utils.CIntDef(i.NEWS_PRICE3);
        ...
        public List<Pro_details_entity> Loadpro_cookie(int type, List<string> listnews_url)
        {
            try
            {
                ...
                var list = (from a in db.ESHOP_NEWS_CATs
                            ...
                            select new { b.NEWS_ID, b.UNIT_ID1, b.NEWS_TITLE, b.NEWS_IMAGE3, b.NEWS_PRICE1, b.NEWS_PRICE2, b.NEWS_PRICE3, b.NEWS_DESC, b.NEWS_SEO_URL, b.NEWS_URL, b.NEWS_ORDER, b.NEWS_ORDER_PERIOD, b.NEWS_PUBLISHDATE, b.NEWS_CODE, b.NEWS_COUNT, c.CAT_SEO_URL }).OrderByDescending(n => n.NEWS_PUBLISHDATE).OrderByDescending(n => n.NEWS_ORDER).ToList();
                foreach (var i in list)
                {
                    Pro_details_entity pro = new Pro_details_entity();
                    pro.NEWS_ID = i.NEWS_ID;
